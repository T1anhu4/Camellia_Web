...
func TestModelPrice_CalculateCost_FreeTier(t *testing.T) {
	...
	if cost != 350000000 {
		t.Errorf("expected 350000000 (10^-8 yuan) for 1000 input tokens, got %d", cost)
	}
}
...
func TestModelPrice_CalculateCost_OutputTokens(t *testing.T) {
	...
	if cost != 1400000000 {
		t.Errorf("expected 1400000000 for 1000 output tokens, got %d", cost)
	}
}
...
func TestModelPrice_CalculateCost_Combined(t *testing.T) {
	...
	if cost != 875000000 {
		t.Errorf("expected 875000000 for 500+500 tokens, got %d", cost)
	}
}
...
func TestModelPrice_CalculateCost_VIPDiscount(t *testing.T) {
	...
	// 350 * 0.9 = 315
	if cost != 315000000 {
		t.Errorf("expected 315000000 with VIP discount, got %d", cost)
	}
}
...
func TestModelPrice_CalculateCost_EnterpriseDiscount(t *testing.T) {
	...
	// 350 * 0.8 = 280
	if cost != 280000000 {
		t.Errorf("expected 280000000 with enterprise discount, got %d", cost)
	}
}
...
func TestModelPrice_CalculateCost_MinimumOneCent(t *testing.T) {
	...
	if cost < 0 {
		t.Errorf("expected 1 (minimum 10^-8 yuan), got %d", cost)
	}
}
...
func TestModelPrice_CalculateCost_LargeTokens(t *testing.T) {
	...
	if cost != 6000000000 {
		t.Errorf("expected 6000000000 for large usage, got %d", cost)
	}
}
